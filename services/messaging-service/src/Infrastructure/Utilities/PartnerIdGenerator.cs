...
namespace MessagingService.Infrastructure.Utilities;

/// <summary>
/// Utility for generating deterministic PartnerId from user email
/// Uses MD5 hash to ensure consistency across services (matches onboarding-api)
/// </summary>
public static class PartnerIdGenerator
{
    ...
    public static Guid GenerateFromEmail(string email)
    {
        ...
        // Use MD5 hash to generate deterministic GUID (matches onboarding-api)
