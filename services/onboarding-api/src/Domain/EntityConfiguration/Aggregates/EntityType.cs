...
public class EntityType
{
    ...
    public void AddRequirement(Guid requirementId, bool isRequired, int displayOrder)
    {
        if (_requirements.Any(r => r.RequirementId == requirementId))
        ...
        // Don't update UpdatedAt here - let SaveChangesAsync handle it automatically
        // This avoids concurrency issues when modifying owned collections
    }
...
public class EntityTypeRequirement
{
    ...
    // Navigation property to the actual Requirement entity
