using OnboardingApi.Domain.WorkQueue.Events;
...
public class WorkItem
{
        ...
        int slaDays = 5)
    {
        var workItem = new WorkItem
        {
            ...
            RiskLevel = riskLevel,
            RequiresApproval = riskLevel is RiskLevel.High or RiskLevel.Critical,
    ...
    private static WorkItemPriority DeterminePriority(RiskLevel riskLevel)
    {
        ...
        return riskLevel switch
        {
            ...
            RiskLevel.Unknown => WorkItemPriority.Medium, // Default until manually assessed
