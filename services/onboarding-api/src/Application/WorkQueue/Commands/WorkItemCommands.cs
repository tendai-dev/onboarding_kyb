...
public record UpdateStepReviewStatusCommand(
    Guid WorkItemId,
    string StepId,
    string Field, // "completed", "verified", or "approved"
    bool Value,
    string UpdatedByUserId,
    string UpdatedByUserName,
    string? Notes = null
) : IRequest<UpdateStepReviewStatusResult>;

public record UpdateStepReviewStatusResult
{
    public bool Success { get; init; }
    public string? ErrorMessage { get; init; }
    
    public static UpdateStepReviewStatusResult Successful() => new() { Success = true };
