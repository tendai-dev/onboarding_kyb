...
public interface IEntityTypeRepository
{
    ...
    Task<bool> AddRequirementDirectlyAsync(Guid entityTypeId, Guid requirementId, bool isRequired, int displayOrder, CancellationToken cancellationToken = default);
}
