...
public class RiskAssessmentController : ControllerBase
{
    ...
    /// This will automatically transition the case to Risk Review phase
    /// </summary>
    [HttpPost]
    ...
    public async Task<IActionResult> CreateRiskAssessment([FromBody] CreateRiskAssessmentRequest request)
    {
        ...
        var command = new CreateRiskAssessmentCommand(request.CaseId, request.PartnerId, initiatedBy);
