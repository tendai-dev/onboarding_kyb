...
public class ProjectionsDbContext : DbContext
{
    ...
    public DbSet<OnboardingCaseProjection> OnboardingCases { get; set; } = null!;

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);

        // Use projections schema for separation
        ...
        {
            entity.ToTable("onboarding_case_projections", "projections");
