...
public class WorkQueueDbContext : DbContext
{
    ...
    public DbSet<WorkItemStepReview> WorkItemStepReviews { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Configure WorkItemStepReview entity
        modelBuilder.Entity<WorkItemStepReview>(entity =>
        {
            entity.ToTable("work_item_step_reviews", "work_queue");
            ...
            entity.HasIndex(e => new { e.WorkItemId, e.StepId }).IsUnique();
        });
    }
}
