...
public class CreateEntityTypeCommandHandlerTests
{
    ...
    public CreateEntityTypeCommandHandlerTests()
    {
        ...
        var logger = new Microsoft.Extensions.Logging.Abstractions.NullLogger<CreateEntityTypeCommandHandler>();
        _handler = new CreateEntityTypeCommandHandler(_repositoryMock, logger);
    }
