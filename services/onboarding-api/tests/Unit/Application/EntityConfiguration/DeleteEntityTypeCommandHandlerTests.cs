...
public class DeleteEntityTypeCommandHandlerTests
{
    ...
    public DeleteEntityTypeCommandHandlerTests()
    {
        ...
        var logger = new Microsoft.Extensions.Logging.Abstractions.NullLogger<DeleteEntityTypeCommandHandler>();
        _handler = new DeleteEntityTypeCommandHandler(_repositoryMock, logger);
    }
