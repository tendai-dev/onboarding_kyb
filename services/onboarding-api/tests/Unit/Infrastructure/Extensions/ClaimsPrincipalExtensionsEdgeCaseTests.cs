...
public class ClaimsPrincipalExtensionsEdgeCaseTests
{
    [Fact]
    ...
    [Fact]
    public void IsExternalUser_ShouldReturnTrue_WhenHasPreferredUsername()
    {
        // Arrange
    ...
    [Fact]
    public void IsExternalUser_ShouldReturnTrue_WhenHasEmail()
    {
        // Arrange
    ...
    [Fact]
    public void IsInternalUser_ShouldReturnTrue_WhenHasWindowsAccountName()
    {
        // Arrange
    ...
    [Fact]
    public void IsInternalUser_ShouldReturnTrue_WhenHasUpn()
    {
        // Arrange
        var claims = new List<Claim> 
        { 
