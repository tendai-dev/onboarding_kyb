...
public class MockEntityTypeRepository : OnboardingApi.Application.EntityConfiguration.Interfaces.IEntityTypeRepository
{
    ...
    public Task<bool> AddRequirementDirectlyAsync(Guid entityTypeId, Guid requirementId, bool isRequired, int displayOrder, CancellationToken cancellationToken = default)
    {
        if (_entityTypes.TryGetValue(entityTypeId, out var entityType))
        {
