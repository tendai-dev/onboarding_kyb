...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("Service", Environment.GetEnvironmentVariable("SERVICE_NAME") ?? "kyc-risk-api")
    .CreateLogger();
...
{
    c.SwaggerDoc("v1", new() { Title = Environment.GetEnvironmentVariable("SERVICE_NAME") ?? "KYC Risk API", Version = "v1" });
