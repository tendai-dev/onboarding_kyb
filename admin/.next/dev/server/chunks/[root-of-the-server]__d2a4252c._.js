;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="704ac48a-b960-0ed7-5132-8caf1cef4f84")}catch(e){}}();
module.exports = [
        ...
        async jwt ({ token, account, user, trigger, session: sessionData }) {
            try {
                ...
                if (account && user) {
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].debug('[NextAuth] JWT callback - User data', {
                            userId: user.id,
                            userName: user.name,
                    ...
                    token.user = {
                        ...
                        name: user.name || token.name || token.given_name + ' ' + token.family_name || undefined,
                    ...
                    if (user.name) token.name = user.name;
                        ...
                        token.name = `${token.given_name} ${token.family_name}`;
                    ...
                    try {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sentry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reportError"])(error, {
                            tags: {
                                error_type: 'redis_token_storage',
                                operation: 'store_token_session'
                            },
                            extra: {
                                sessionId,
                                userEmail: user.email
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error(error, '[NextAuth] JWT callback error', {
                    tags: {
                        error_type: 'jwt_callback'
                    },
                    extra: {
                        stack: error?.stack
                    }
            ...
            try {
                ...
                if (token.user) {
                    session.user = {
                        ...
                        name: token.user.name || token.name ? token.name : undefined,
                        email: token.user.email || token.email ? token.email : undefined,
                        image: token.user.image || token.picture ? token.picture : undefined
                    };
                } else if (token.name || token.email) {
                    // Use token fields directly if user object not available
                    session.user = {
                        id: token.sub || undefined,
                        name: token.name ? token.name : undefined,
                        email: token.email ? token.email : undefined,
                        image: token.picture ? token.picture : undefined
                    };
                }
...
const { handlers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
// Wrap handlers with error logging
const GET = async (req)=>{
    try {
        return await handlers.GET(req);
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error(error, '[NextAuth] GET handler error', {
            tags: {
                error_type: 'nextauth_handler_error'
            },
            extra: {
                url: req.url
            }
...
const POST = async (req)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error(error, '[NextAuth] POST handler error', {
            tags: {
                error_type: 'nextauth_handler_error'
            },
            extra: {
...
//# debugId=704ac48a-b960-0ed7-5132-8caf1cef4f84
//# sourceMappingURL=%5Broot-of-the-server%5D__d2a4252c._.js.map