;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="46083eef-49a9-7012-1804-8951c0a1d088")}catch(e){}}();
module.exports = [
...
"[project]/src/app/api/requirements/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    console.log('[Requirements API Route] GET request received:', request.url);
    try {
        ...
        console.log('[Requirements API Route] Session:', session ? 'authenticated' : 'not authenticated');
        const searchParams = request.nextUrl.searchParams;
        const queryString = searchParams.toString();
        console.log('[Requirements API Route] Query params:', queryString);
        ...
        console.log('[Requirements API Route] Proxying to:', proxyUrl.toString());
        // Prepare headers
        const headers = {
            'Content-Type': 'application/json'
        };
        ...
        console.error('[Requirements API Route] Request error:', {
            error: errorMessage,
...
//# debugId=46083eef-49a9-7012-1804-8951c0a1d088
//# sourceMappingURL=%5Broot-of-the-server%5D__a7623723._.js.map