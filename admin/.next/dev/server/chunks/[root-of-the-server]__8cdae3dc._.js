;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="bcd42082-bcc2-c1c0-8f20-34d0fd26606d")}catch(e){}}();
module.exports = [
...
// @ts-ignore - NextAuth v5 beta compatibility
__turbopack_context__.s([
    "auth",
    ()=>auth,
    "authOptions",
...
async function GET(request) {
    console.log('[Applications API Route] GET request received:', request.url);
    try {
        ...
        console.log('[Applications API Route] Session:', session ? 'authenticated' : 'not authenticated');
        const searchParams = request.nextUrl.searchParams;
        const queryString = searchParams.toString();
        console.log('[Applications API Route] Query params:', queryString);
        ...
        if (!response.ok) {
            ...
            console.error('[Applications API Route] Backend error:', {
        ...
        try {
            ...
            if (!responseText || responseText.trim() === '') {
                console.warn('[Applications API Route] Empty response from backend');
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    items: [],
                    totalCount: 0,
                    page: 1,
            ...
            console.error('[Applications API Route] Failed to parse response:', {
        ...
        console.error('[Applications API Route] Request error:', {
            error: errorMessage,
...
//# debugId=bcd42082-bcc2-c1c0-8f20-34d0fd26606d
//# sourceMappingURL=%5Broot-of-the-server%5D__8cdae3dc._.js.map