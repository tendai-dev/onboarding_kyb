;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="629352ba-4c4d-f2c0-978a-d6f7fa7e2e5c")}catch(e){}}();
module.exports = [
...
async function GET(request) {
    try {
        ...
        console.log('[WorkQueue API Route] Proxying request to:', proxyUrl.toString());
        // Prepare headers
        const headers = {
            'Content-Type': 'application/json'
        };
        ...
        if (!response.ok) {
            ...
            console.error('[WorkQueue API Route] Backend error:', {
        ...
        try {
            ...
            if (!responseText || responseText.trim() === '') {
                console.warn('[WorkQueue API Route] Empty response from backend');
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    items: [],
                    total_count: 0,
                    page: 1,
            ...
            console.error('[WorkQueue API Route] Failed to parse response:', {
        ...
        console.error('[WorkQueue API Route] Request error:', {
            error: errorMessage,
 ...
 */ async function forwardRequest(request, method) {
    try {
        ...
        if (!response.ok) {
            ...
            console.error('[WorkQueue API Route] Backend error in forwardRequest:', {
                status: response.status,
                statusText: response.statusText,
                body: errorText,
                errorJson,
...
//# debugId=629352ba-4c4d-f2c0-978a-d6f7fa7e2e5c
//# sourceMappingURL=%5Broot-of-the-server%5D__6c6e15a8._.js.map