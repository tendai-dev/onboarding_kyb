...
export function PushNotificationSettings() {
  ...
  return (
    <VStack align="stretch" gap="4">
      ...
      {permission === 'default' && (
        <Button colorScheme="blue" onClick={requestPermission} loading={isLoading}>
          <Icon as={FiBell} mr="2" />
...
// Note: Service worker removed per requirements - update detection disabled
// This component is kept for API compatibility but will always return null
export function PWAUpdateAvailable() {
  // Component always returns null since update detection is disabled
  return null;
  ...
  return (
    <Alert.Root status="info" borderRadius="md" mb="4">
      ...
      <Button size="sm" colorScheme="blue" onClick={handleUpdate} loading={isUpdating}>
