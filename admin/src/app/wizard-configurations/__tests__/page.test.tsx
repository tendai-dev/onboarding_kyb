...
describe('WizardConfigurationsPage', () => {
  ...
  beforeEach(() => {
    ...
    (entityConfigApiService.getWizardConfigurations as unknown).mockResolvedValue(
      mockConfigurations
    );
  });
  ...
  it('should handle delete configuration', async () => {
    (entityConfigApiService.deleteWizardConfiguration as unknown).mockResolvedValue({});
  ...
  it('should handle error state', async () => {
    (entityConfigApiService.getWizardConfigurations as unknown).mockRejectedValueOnce(
  ...
  it('should display empty state when no configurations', async () => {
    (entityConfigApiService.getWizardConfigurations as unknown).mockResolvedValueOnce([]);
