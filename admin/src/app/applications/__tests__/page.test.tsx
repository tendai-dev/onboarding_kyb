...
describe('ApplicationsPage', () => {
  ...
  beforeEach(() => {
    ...
    (applicationServices.fetchApplications as unknown).mockResolvedValue({
      items: mockApplications,
      total: 5,
      page: 1,
      pageSize: 1000,
    });
    (applicationServices.exportApplications as unknown).mockResolvedValue(
  ...
  it('should handle error state and display error message', async () => {
    ...
    (applicationServices.fetchApplications as unknown).mockRejectedValueOnce(
  ...
  it('should handle export error', async () => {
    ...
    (applicationServices.exportApplications as unknown).mockRejectedValueOnce(
      new Error(errorMessage)
    );
  ...
  it('should display empty state when no applications', async () => {
    (applicationServices.fetchApplications as unknown).mockResolvedValueOnce({
      items: [],
      total: 0,
      page: 1,
      pageSize: 1000,
  ...
  it('should handle loading state', async () => {
    ...
    (applicationServices.fetchApplications as unknown).mockImplementation(
      () =>
        new Promise((resolve) =>
          setTimeout(
            () =>
  ...
  it('should handle status color mapping correctly', async () => {
    renderWithProviders(<ApplicationsPage />);
    ...
    // Component should handle all status colors
    expect(document.body).toBeInTheDocument();
  });

  it('should handle risk color mapping correctly', async () => {
    renderWithProviders(<ApplicationsPage />);
    ...
    // Component should handle all risk level colors
    expect(document.body).toBeInTheDocument();
  });
  ...
  it('should handle loading state during export', async () => {
    (applicationServices.exportApplications as unknown).mockImplementation(
      () =>
        new Promise((resolve) =>
          setTimeout(() => resolve(new Blob(['test'], { type: 'text/csv' })), 100)
        )
    );
