...
describe('RulesAndPermissionsPage', () => {
  ...
  beforeEach(() => {
    ...
    (rulesAndPermissionsApiService.getAllRoles as unknown).mockResolvedValue(mockRoles);
    (rulesAndPermissionsApiService.getAllUsers as unknown).mockResolvedValue(mockUsers);
  });
  ...
  it('should switch to users tab', async () => {
    ...
    if (usersTab) {
      ...
      await waitFor(() => {
        expect(rulesAndPermissionsApiService.getAllUsers).toHaveBeenCalled();
      });
    }
  });
  ...
  it('should handle create role', async () => {
    (rulesAndPermissionsApiService.createRole as unknown).mockResolvedValue(mockRoles[0]);
  ...
  it('should handle edit role', async () => {
    (rulesAndPermissionsApiService.getRoleById as unknown).mockResolvedValue(
      mockRoles[0]
    );
    (rulesAndPermissionsApiService.updateRole as unknown).mockResolvedValue(mockRoles[0]);
  ...
  it('should handle delete role', async () => {
    (rulesAndPermissionsApiService.deleteRole as unknown).mockResolvedValue({});
  ...
  it('should handle grant permission to user', async () => {
    (rulesAndPermissionsApiService.grantPermission as unknown).mockResolvedValue({});
  ...
  it('should handle assign role to user', async () => {
    (rulesAndPermissionsApiService.assignRoleToUser as unknown).mockResolvedValue({});
  ...
  it('should handle error state', async () => {
    (rulesAndPermissionsApiService.getAllRoles as unknown).mockRejectedValueOnce(
  ...
  it('should handle loading state', async () => {
    (rulesAndPermissionsApiService.getAllRoles as unknown).mockImplementation(
  ...
  it('should display empty state when no roles', async () => {
    (rulesAndPermissionsApiService.getAllRoles as unknown).mockResolvedValueOnce([]);
  ...
  it('should display empty state when no users', async () => {
    (rulesAndPermissionsApiService.getAllUsers as unknown).mockResolvedValueOnce([]);
