...
describe('EditRequirementPage', () => {
  ...
  beforeEach(() => {
    ...
    (entityConfigApi.entityConfigApiService.getRequirement as unknown).mockResolvedValue(
      mockRequirement
    );
  });
  ...
  it('should load requirement data', async () => {
    renderWithProviders(<EditRequirementPage params={{ id: 'req-1' }} />);
    await waitFor(() => {
      expect(entityConfigApi.entityConfigApiService.getRequirement).toHaveBeenCalledWith(
        'req-1'
      );
    });
  });
  ...
  it('should handle form submission', async () => {
    (
      entityConfigApi.entityConfigApiService.updateRequirement as unknown
  ...
  it('should handle error state', async () => {
    (
      entityConfigApi.entityConfigApiService.getRequirement as unknown
