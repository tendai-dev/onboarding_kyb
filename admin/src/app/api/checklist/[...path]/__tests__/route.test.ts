...
describe('Checklist Dynamic Path API Route', () => {
  ...
  it('should handle POST request', async () => {
    ...
    const request = createMockRequest('http://localhost:3000/api/checklist', 'POST', JSON.stringify({}));
  ...
  it('should handle PUT request', async () => {
    ...
    const request = createMockRequest('http://localhost:3000/api/checklist/checklist-1', 'PUT', JSON.stringify({}));
  ...
  it('should handle DELETE request', async () => {
    ...
    const request = createMockRequest('http://localhost:3000/api/checklist/checklist-1', 'DELETE');
