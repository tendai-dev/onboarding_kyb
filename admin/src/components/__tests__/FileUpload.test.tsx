...
// Mock DataTransfer
(global as { DataTransfer?: unknown }).DataTransfer = class DataTransferMock {
  private _files: File[] = [];
      ...
      add: (file: File | string, _type?: string) => {
        if (file instanceof File) {
          ...
          return {
            ...
            type: file.type,
            getAsFile: () => file,
            getAsString: (callback: (str: string) => void) => callback(file.name),
...
describe('FileUpload', () => {
  ...
  it('should handle drag and drop', async () => {
    ...
    const dropZone =
      (vstack?.firstChild as HTMLElement) ||
  ...
  it('should validate file type', async () => {
    ...
    const { container } = renderWithProviders(
      <FileUpload onFileUpload={mockOnFileUpload} acceptedTypes={acceptedTypes} />
    );
  ...
  it('should validate file size', async () => {
    ...
    const { container } = renderWithProviders(
      <FileUpload onFileUpload={mockOnFileUpload} maxSize={maxSize} />
    );
  ...
  it('should handle drag enter', () => {
    ...
    const dropZone =
      container.querySelector('[data-testid="file-upload-dropzone"]') ||
