...
describe('DynamicForm', () => {
  ...
  it('should handle initial data', () => {
    ...
    renderWithProviders(
      <DynamicForm fields={mockFields} onSubmit={onSubmit} initialData={initialData} />
    );
  ...
  it('should handle conditional fields', async () => {
    ...
    const onSubmit = vi.fn();
    renderWithProviders(<DynamicForm fields={conditionalFields} onSubmit={onSubmit} />);
  ...
  it('should handle disabled state', () => {
    ...
    renderWithProviders(
      <DynamicForm fields={mockFields} onSubmit={onSubmit} disabled={true} />
    );
  ...
  it('should handle loading state', () => {
    ...
    renderWithProviders(
      <DynamicForm fields={mockFields} onSubmit={onSubmit} loading={true} />
    );
  ...
  it('should handle custom validation', async () => {
    ...
    const onSubmit = vi.fn();
    renderWithProviders(
      <DynamicForm fields={customValidationFields} onSubmit={onSubmit} />
    );
  ...
  it('should handle grouped fields', () => {
    ...
    const onSubmit = vi.fn();
    renderWithProviders(<DynamicForm fields={groupedFields} onSubmit={onSubmit} />);
