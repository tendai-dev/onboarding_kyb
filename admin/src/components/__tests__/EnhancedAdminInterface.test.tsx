  ...
  it('should render enhanced admin interface', () => {
    renderWithProviders(
      <EnhancedAdminInterface
        ...
        onUpdateApplication={mockHandlers.onUpdateApplication}
        onAssignApplications={mockHandlers.onAssignApplications}
        onTagApplications={mockHandlers.onTagApplications}
        onExportApplications={mockHandlers.onExportApplications}
      />
    );
