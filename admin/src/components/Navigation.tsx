...
import { Link } from '@mukuru/mukuru-react-components';
...
const adminNavItems = [
  ...
  { label: 'Work Queue', href: '/work-queue', icon: '⏳' },
...
export default function Navigation({
  ...
  const NavContent = () => (
    <VStack gap="1" align="stretch">
      {navItems.map((item: Record<string, unknown>) => {
            ...
            <Box p="4" width="100%" borderTop="1px" borderColor="gray.100">
              <Menu.Root>
                ...
                <Menu.Content>
                  ...
                  <Menu.Separator />
                  <Menu.Item value="help" color="red.500">
                    Help & Support
                  </Menu.Item>
                  <Menu.Item value="signout" color="red.500">
                    Sign Out
                  </Menu.Item>
                </Menu.Content>
              </Menu.Root>
