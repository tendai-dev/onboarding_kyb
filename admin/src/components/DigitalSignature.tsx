...
export function DigitalSignature({
  ...
  const signaturePadRef = useRef<unknown>(null);
  ...
  const clearSignature = () => {
    ...
    if (signaturePadRef.current) {
      const pad = signaturePadRef.current as { clear?: () => void };
      if (pad.clear) {
        pad.clear();
      }
    }
  ...
  const getStatusColor = (status: SignatureField['status']) => {
    switch (status) {
      case 'signed':
        return 'green';
      case 'pending':
  ...
  const getStatusIcon = (status: SignatureField['status']) => {
    switch (status) {
      case 'signed':
      ...
      <Box bg="white" borderBottom="1px" borderColor="gray.200" p="6">
        <VStack gap="4" align="stretch">
          ...
          <Box>
            ...
            <Text fontSize="xs" color="mukuru.grey.medium" mt="1" textAlign="center">
              ...
              <VStack gap="4" align="stretch">
                ...
                {currentPageFields.map((field) => (
                  <Box
                    ...
                    onClick={() =>
                      field.status === 'pending' && handleSignatureStart(field)
                    }
        ...
        <Box width="350px" bg="white" borderLeft="1px" borderColor="gray.200" p="6">
          <VStack gap="6" align="stretch">
              ...
              <VStack gap="2" align="stretch">
                {document.signatureFields.map((field) => (
                  <HStack
                    ...
                    borderColor={
                      field.pageNumber === currentPage ? 'orange.200' : 'transparent'
                    }
                  >
                    <Icon
                      as={getStatusIcon(field.status)}
                      color={`${getStatusColor(field.status)}.500`}
                      boxSize="4"
                    />
            ...
            <VStack gap="3" align="stretch">
              ...
              <Button variant="outline" colorScheme="red" onClick={onDeclineOpen}>
                <Icon as={FiX} mr="2" />
                Decline to Sign
              </Button>
            </VStack>
                ...
                >
                  <HStack gap="2">
                    ...
                    <Text fontSize="sm" color="blue.700">
                      Please sign in the box below. Your signature will be legally
                      binding.
                    </Text>
                  </HStack>
                </Box>
