...
export function useKeyboardShortcuts() {
  ...
  const unregisterShortcut = (key: string) => {
    setShortcuts((prev) => {
      const { [key]: _removed, ...rest } = prev; // eslint-disable-line @typescript-eslint/no-unused-vars
      return rest;
    });
  };
                ...
                <VStack align="stretch" gap="4">
                  ...
                  <HStack justify="space-between">
                    ...
                    <Switch.Root
                      ...
                      onCheckedChange={(details) =>
                        setAnimations(details.checked === true)
                      }
                    >
                      <Switch.Indicator />
                    </Switch.Root>
                  ...
                  <HStack justify="space-between">
                    ...
                    <Switch.Root
                      ...
                      onCheckedChange={(details) =>
                        setReducedMotion(details.checked === true)
                      }
                    >
                      <Switch.Indicator />
                    </Switch.Root>
...
export function UserPreferences() {
  ...
  return (
    ...
    >
      ...
      <VStack align="stretch" gap="4">
        ...
        <HStack justify="space-between">
          ...
          <select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
              setTheme(
                e.target.value as 'default' | 'high-contrast' | 'colorblind-friendly'
              )
            }
            style={{
              width: '200px',
      ...
      <Box height="1px" bg="mukuru.grey.light" my="4" />
  ...
  const actions = [
    {
      ...
      action: () => console.info('New Application'),
    },
    { icon: FiSearch, label: 'Search', action: () => console.info('Search') },
    { icon: FiDownload, label: 'Export', action: () => console.info('Export') },
    { icon: FiUpload, label: 'Import', action: () => console.info('Import') },
    { icon: FiSave, label: 'Save', action: () => console.info('Save') },
    { icon: FiRefreshCw, label: 'Refresh', action: () => console.info('Refresh') },
    { icon: FiSettings, label: 'Settings', action: () => console.info('Settings') },
    { icon: FiInfo, label: 'Help', action: () => console.info('Help') },
  ];
      ...
      <SimpleGrid columns={4} gap="4">
        {actions.map((action, index) => (
          <Tooltip.Root key={index}>
            <Tooltip.Trigger>
              <Button variant="outline" size="lg" onClick={action.action}>
