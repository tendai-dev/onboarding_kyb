          ...
          >
            <Box p="4" borderBottom="1px" borderColor="gray.200">
              <HStack justify="space-between">
                <Text fontWeight="bold" fontSize="lg">Theme & Accessibility Settings</Text>
            ...
            <Box p="4">
              <VStack align="stretch" gap="6">
                {/* Color Mode */}
                <Box>
                  <Text fontSize="sm" fontWeight="medium" mb="2">Color Mode</Text>
                  <HStack gap="4">
                    <Button
                      size="sm"
                ...
                {/* Theme Variant */}
                <Box>
                  <Text fontSize="sm" fontWeight="medium" mb="2">Theme Variant</Text>
                  <select
                    value={theme}
                    onChange={(e: any) => setTheme(e.target.value as any)}
                    style={{
                      width: '100%',
                      padding: '8px',
                      fontSize: '14px',
                ...
                {/* Font Size */}
                <Box>
                  <Text fontSize="sm" fontWeight="medium" mb="2">Font Size</Text>
                  <HStack gap="4">
                ...
                <VStack align="stretch" gap="4">
                  ...
                  <HStack justify="space-between">
                    ...
                    <Switch.Root
                      checked={animations}
                      onCheckedChange={(details) => setAnimations(details.checked === true)}
                    >
                      <Switch.Indicator />
                    </Switch.Root>
                  </HStack>
                  ...
                  <HStack justify="space-between">
                    ...
                    <Switch.Root
                      ...
                      onCheckedChange={(details) => setReducedMotion(details.checked === true)}
                    >
                      <Switch.Indicator />
                    </Switch.Root>
                  </HStack>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <Box p="4" borderBottom="1px" borderColor="gray.200">
              <HStack justify="space-between">
                <Text fontWeight="bold" fontSize="lg">Keyboard Shortcuts</Text>
                <Button variant="ghost" size="sm" onClick={onClose}>
                  <Icon as={FiX} />
                </Button>
              </HStack>
...
export function UserPreferences() {
  ...
  return (
    <VStack align="stretch" gap="6" p="6" bg="white" borderRadius="lg" border="1px" borderColor="gray.200">
      ...
      <VStack align="stretch" gap="4">
        <HStack justify="space-between">
          ...
          <Switch.Root
            checked={isEnabled}
            onCheckedChange={(details) => setIsEnabled(details.checked === true)}
          >
            <Switch.Indicator />
          </Switch.Root>
        </HStack>
...
export function QuickActions() {
  const actions = [
    { icon: FiPlus, label: 'New Application', action: () => console.log('New Application') },
    { icon: FiSearch, label: 'Search', action: () => console.log('Search') },
    { icon: FiDownload, label: 'Export', action: () => console.log('Export') },
    { icon: FiUpload, label: 'Import', action: () => console.log('Import') },
    { icon: FiSave, label: 'Save', action: () => console.log('Save') },
    { icon: FiRefreshCw, label: 'Refresh', action: () => console.log('Refresh') },
    { icon: FiSettings, label: 'Settings', action: () => console.log('Settings') },
    { icon: FiInfo, label: 'Help', action: () => console.log('Help') }
  ];

  return (
    <VStack align="stretch" gap="4" p="6" bg="white" borderRadius="lg" border="1px" borderColor="gray.200">
