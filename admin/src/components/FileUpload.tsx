...
import { Box, VStack, HStack, Circle, Image, Progress } from '@chakra-ui/react';
// Import components directly from Mukuru package
import { Typography, Button, Tag, IconWrapper } from '@mukuru/mukuru-react-components';
import { FiUpload, FiCheck, FiX, FiAlertCircle, FiCloud } from 'react-icons/fi';
            ...
            >
              <HStack justify="space-between" align="center">
                <HStack gap="3" flex="1">
                  ...
                  <Tag
                    variant={
                      getStatusColor(uploadedFile.status) === 'green'
                        ? 'success'
                        : getStatusColor(uploadedFile.status) === 'red'
                          ? 'danger'
                          : 'info'
                    }
                  >
              ...
              {uploadedFile.status === 'error' && uploadedFile.error && (
                ...
                >
                  <HStack gap="2">
                    <IconWrapper>
                      <FiAlertCircle size={16} color="#E53E3E" />
                    </IconWrapper>
