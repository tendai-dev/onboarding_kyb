...
describe('validation', () => {
  ...
  describe('documentValidation', () => {
    it('should validate file type', () => {
      ...
      const result = documentValidation.validateFileType(file);
    ...
    it('should validate file size', () => {
      const file = new File(['content'], 'test.pdf', { type: 'application/pdf' });
      const result = documentValidation.validateFileSize(file);
      expect(result).toBe(true);
    });
    ...
    it('should validate file name', () => {
      ...
      expect(documentValidation.validateFileName('testfile-123.pdf')).toBe(true);
    });
  ...
  describe('riskAssessmentValidation', () => {
    ...
    it('should get required approvals for medium risk', () => {
      const approvals = riskAssessmentValidation.getRequiredApprovals(
        'medium',
        'pty_ltd'
      );
      expect(approvals).toContain('senior_manager');
  ...
  describe('externalValidation', () => {
    ...
    it('should validate company registration', async () => {
      const promise = externalValidation.validateCompanyRegistration(
        '2019/123456/07',
        'za'
      );
