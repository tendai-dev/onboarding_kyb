...
export const entityValidationSchemas = {
  pty_ltd: Yup.object().shape({
    ...
    registrationNumber: Yup.string()
      ...
      .test('valid-format', 'Invalid registration number format', function (value) {
        ...
        const pattern =
          registrationPatterns[country as keyof typeof registrationPatterns];
  ...
  npo_ngo: Yup.object().shape({
    ...
    registrationNumber: Yup.string().required('NPO registration number is required'),
    purpose: Yup.string()
  ...
  banking: Yup.object().shape({
    ...
    swiftCode: Yup.string()
      ...
      .when('isInternational', {
        is: true,
        then: (schema) =>
          schema.required('SWIFT code is required for international transfers'),
      }),
  }),
...
export const documentValidation = {
  ...
  getRequiredDocuments: (entityType: string, isEPP: boolean = false) => {
    const documentRequirements = {
      pty_ltd: [
        ...
        },
        {
          ...
          description:
            'Business letterhead, invoice, or website extract (if different from registered name)',
          required: false,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
        ...
        },
        {
          ...
          description:
            'Lease agreement, utility bill, bank statement (not older than 3 months)',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'address',
        },
        {
          ...
          description:
            'Address proof if different from registered address (not older than 3 months)',
          required: false,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'address',
        },
        ...
        },
        {
          ...
          description:
            'Memorandum of Incorporation, Shareholders Register, Share Certificates',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'ownership',
        },
      ...
      government: [
        {
          ...
          description:
            'Registration certificate, Act of Parliament, or official registration documents',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'registration',
        },
      ...
      npo_ngo: [
        {
          ...
          description:
            'Registration certificate, certificate of incorporation, or governing document',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'registration',
        },
        {
          ...
          description:
            'Valid NPO/NGO certificate or license (if applicable in operating country)',
          required: false,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'licensing',
        },
        ...
        },
        {
          ...
          name: 'Proof of Registered Address',
          description:
            'Address proof if not in registration documents (not older than 3 months)',
          required: false,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'address',
        },
        ...
        },
        {
          ...
          description:
            'Annual report, financial statements, or official document listing trustees/management',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'governance',
        },
        {
          ...
          description:
            'Valid ID/passport for individuals with ≥25% control or management responsibility',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'identity',
        },
      ...
      association: [
        {
          ...
          description:
            'Constitution, mission statement, charter, or other official document',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'governance',
        },
        ...
        },
        {
          ...
          name: 'Key Controllers List',
          description:
            'Annual report, financial statements, or official document listing members/officials',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'governance',
        },
      ...
      trust: [
        ...
        },
        {
          ...
          name: 'Proof of Trading/Operating Name',
          description:
            'Business letterhead, invoice, or website extract (if different from trust name)',
          required: false,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'identification',
        },
        ...
        },
        {
          ...
          description:
            'Valid ID/passport for all trustees and related parties (beneficiaries/founders/settlor)',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'identity',
        },
      ...
      supranational: [
        ...
        },
        {
          ...
          description:
            'Reference to reliable website or 3rd party document evidencing existence',
          required: true,
      ...
      sole_proprietor: [
        ...
        },
        {
          ...
          name: 'Board of Directors List',
          description:
            'Registration certificate, annual report, or official document listing directors',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'governance',
        },
        ...
        },
        {
          ...
          name: 'Beneficial Owners ID Documents',
          description:
            'Valid ID/passport for individuals with ≥25% shareholding or management responsibility',
          required: true,
          acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
          category: 'identity',
        },
    ...
    // Note: financialInstitutionDocs was defined but not used
    // The getFinancialInstitutionDocuments function below provides this functionality
...
// NOTE: Automated risk calculation is DEPRECATED
// All risk assessments must be done manually by authorized personnel
// These functions are kept for backward compatibility only and should NOT be used for automatic risk classification
export const riskAssessmentValidation = {
  /**
   * @deprecated Automated risk scoring is deprecated. Risk must be assessed manually by authorized personnel.
   * This function is kept for backward compatibility only.
   */
  calculateRiskScore: (_data: Record<string, unknown>) => {
    // DEPRECATED: Do not use for automatic risk assessment
    // Risk must be manually assessed by case officers, compliance analysts, or designated reviewers
    console.warn('calculateRiskScore is deprecated. Risk must be assessed manually.');
    return 0; // Return 0 to indicate no automatic score
  },

  /**
   * @deprecated Automated risk level determination is deprecated. Risk level must be set manually.
   */
  getRiskLevel: (_score: number) => {
    // DEPRECATED: Do not use for automatic risk classification
    console.warn(
      'getRiskLevel is deprecated. Risk level must be set manually by reviewers.'
    );
    return 'unknown'; // Return unknown to indicate manual assessment required
  },

  getRequiredApprovals: (_riskLevel: string, _entityType?: string) => {
    ...
    if (_entityType === 'government') {
      approvals.push('legal_counsel');
    }

    if (_entityType === 'publicly_listed') {
