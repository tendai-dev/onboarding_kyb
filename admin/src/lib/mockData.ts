...
export const mockApplications: Application[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        message:
          'Thank you for the update. I have uploaded the additional proof of address document as requested.',
    ...
    messages: [
      {
        ...
        message:
          'Congratulations! Your application has been approved. You can now access all services.',
  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          'Certificate of Incorporation requires re-submission with clearer image quality',
        type: 'error',
      },
    ],
    messages: [
      {
        ...
        message:
          'We need you to re-upload your Certificate of Incorporation with better image quality. The current document is not clear enough for verification.',
