...
class MessageTemplatesService {
  ...
  private loadFromStorage(): void {
    try {
      ...
      if (stored) {
        this.templates = JSON.parse(stored) as MessageTemplate[];
      } else {
  ...
  private getDefaultTemplates(): MessageTemplate[] {
    return [
      ...
      },
      {
        ...
        content:
          'We need additional documentation to proceed with your application. Please upload the following documents:',
      ...
      },
      {
        ...
        content:
          'Congratulations! Your application has been approved. We will contact you shortly with next steps.',
...
export const _messageTemplatesService = new MessageTemplatesService();
