...
describe('validationService', () => {
  ...
  it('should validate tax number', async () => {
    const promise = validationService.validateTaxNumber('1234567890', 'za', {
      cache: false,
    });
  ...
  it('should validate bank account', async () => {
    const promise = validationService.validateBankAccount('123456789', '123456', 'za', {
      cache: false,
    });
  ...
  it('should handle validation errors', async () => {
    const promise = validationService.validateCompanyRegistration('invalid', 'za', {
      cache: false,
    });
