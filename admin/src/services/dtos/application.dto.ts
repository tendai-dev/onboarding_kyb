...
export interface OnboardingCaseProjection {
  /** The unique GUID identifier for the projection/case - use this for API calls */
  id: string;
  /** The case number (display string like "CASE-001") - NOT the GUID, use for display only */
  caseId: string;
  type: string;
  status: string;
  partnerId: string;
...
export interface Application {
  /** The unique GUID identifier - use this for API calls (e.g., createWorkItemForCase) */
  id: string;
  companyName: string;
  entityType: string;
