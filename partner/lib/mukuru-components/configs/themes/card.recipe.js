...
import { cardAnatomy as a } from '@chakra-ui/react/anatomy';
const e = r({
  slots: a.keys(),
  className: 'mukuru-card',
  base: {
    root: {
      ...
      _hover: { boxShadow: '0px 8px 12px 8px #DFDFDF60', cursor: 'pointer' },
    },
  },
});
export { e as cardRecipe };
