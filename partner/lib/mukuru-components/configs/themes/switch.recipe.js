...
import { switchAnatomy as t } from '@chakra-ui/react/anatomy';
const e = i({
  slots: t.keys(),
  ...
  base: {
    root: {
      ...
      '--switch-x': { base: 'var(--switch-diff)', _rtl: 'calc(var(--switch-diff) * -1)' },
    },
    label: {
      lineHeight: '1',
      userSelect: 'none',
