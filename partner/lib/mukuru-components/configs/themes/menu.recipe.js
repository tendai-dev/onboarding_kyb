...
const i = e({
  slots: [...t.keys(), 'activeItem'],
  className: 'mukuru-menu',
  base: {
    content: {
    ...
    item: {
      ...
      _highlighted: { backgroundColor: 'transparent', fontWeight: '700' },
    },
    activeItem: {
      color: '#F05423',
      fontWeight: '700',
      _highlighted: { backgroundColor: 'transparent' },
    },
  },
});
export { i as menuRecipe };
