...
const e = t({
  ...
  variants: {
    ...
    size: {
      sm: {
        root: { '--tabs-height': 'sizes.9', '--tabs-content-padding': 'spacing.3' },
        trigger: { py: '1', px: '3', textStyle: 'sm' },
      },
      md: {
        root: { '--tabs-height': 'sizes.10', '--tabs-content-padding': 'spacing.4' },
        trigger: { py: '2', px: '4', textStyle: 'sm' },
      },
      lg: {
        root: { '--tabs-height': 'sizes.11', '--tabs-content-padding': 'spacing.4.5' },
      ...
      line: {
        ...
        trigger: {
          ...
          _selected: {
            ...
            _vertical: { layerStyle: 'indicator.end', '--indicator-offset-x': '-1px' },
          },
        },
      },
      subtle: {
      ...
      outline: {
        ...
        trigger: {
          ...
          _horizontal: {
            ...
            _selected: { borderColor: 'border', borderBottomColor: 'transparent' },
          },
          _vertical: {
            borderStartRadius: 'var(--tabs-trigger-radius)',
            marginEnd: 'var(--line-offset)',
            marginBottom: { _notLast: 'var(--line-offset)' },
            _selected: { borderColor: 'border', borderEndColor: 'transparent' },
          },
        },
      },
      plain: {
