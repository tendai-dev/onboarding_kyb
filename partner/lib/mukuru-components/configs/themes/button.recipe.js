...
const o = r({
  ...
  base: {
    ...
    alignItems: 'center',
    _disabled: { boxShadow: 'none', cursor: 'not-allowed', opacity: 1 },
    _hover: { _disabled: { boxShadow: 'none' } },
  ...
  variants: {
    size: {
      sm: {
        ...
        '& svg': { flexShrink: 0, transform: 'translateY(1px)' },
      },
      md: {
        borderRadius: '36px',
        height: '48px',
        ...
        '& svg': { flexShrink: 0, transform: 'translateY(2px)' },
      },
      icon: { borderRadius: '50%', width: '36px', height: '36px', p: '0', gap: '0' },
    },
    variant: {
      primary: {
        ...
        _hover: {
          ...
          _dark: { color: 'mukuru.primary' },
        },
        _focusVisible: {
          boxShadow: 'inset 0 0 0 3px mukuru.buttons.inactive.orange',
          outline: 'none',
        },
        _active: { backgroundColor: '#D13F11' },
        _disabled: {
          backgroundColor: 'mukuru.grey.light',
        ...
        _dark: { backgroundColor: 'mukuru.white', color: 'mukuru.primary' },
      },
      secondary: {
        ...
        _focusVisible: { boxShadow: '0 0 0 3px rgba(252, 79, 30, 0.5)', outline: 'none' },
        _disabled: {
      ...
      ghost: {
        ...
        _focusVisible: { boxShadow: '0 0 0 2px rgba(0, 0, 0, 0.3)', outline: 'none' },
        _disabled: {
