import type { ServicesMenuProps } from './ServicesMenu.types';
/**
 ...
 */
export declare const ServicesMenu: import('react').ForwardRefExoticComponent<
  ServicesMenuProps & import('react').RefAttributes<HTMLButtonElement>
>;
//# sourceMappingURL=ServicesMenu.d.ts.map
