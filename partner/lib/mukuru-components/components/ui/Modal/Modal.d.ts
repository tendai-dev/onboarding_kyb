...
export declare const ModalHeader: import('react').ForwardRefExoticComponent<
  ModalHeaderProps & import('react').RefAttributes<HTMLDivElement>
>;
/**
...
export declare const ModalBody: import('react').ForwardRefExoticComponent<
  ModalBodyProps & import('react').RefAttributes<HTMLDivElement>
>;
/**
...
export declare const ModalFooter: import('react').ForwardRefExoticComponent<
  ModalFooterProps & import('react').RefAttributes<HTMLDivElement>
>;
/**
