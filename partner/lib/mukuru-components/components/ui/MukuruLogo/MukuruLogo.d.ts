import type { MukuruLogoProps } from './MukuruLogo.types';
/**
 ...
 */
export declare const MukuruLogo: ({
  inverse,
  ...props
}: MukuruLogoProps) => import('react/jsx-runtime').JSX.Element;
//# sourceMappingURL=MukuruLogo.d.ts.map
