import type { SelectionMenuProps } from './SelectionMenu.types';
/**
 ...
 */
export declare const SelectionMenu: import('react').ForwardRefExoticComponent<
  SelectionMenuProps & import('react').RefAttributes<HTMLButtonElement>
>;
