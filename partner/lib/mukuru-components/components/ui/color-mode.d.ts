...
export declare function ColorModeProvider(
...
export declare const ColorModeButton: React.ForwardRefExoticComponent<
  ColorModeButtonProps & React.RefAttributes<HTMLButtonElement>
>;
export declare const LightMode: React.ForwardRefExoticComponent<
  SpanProps & React.RefAttributes<HTMLSpanElement>
>;
export declare const DarkMode: React.ForwardRefExoticComponent<
  SpanProps & React.RefAttributes<HTMLSpanElement>
>;
export {};
