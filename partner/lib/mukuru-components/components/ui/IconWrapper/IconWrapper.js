...
import { Icon as r } from '@chakra-ui/react';
import { forwardRef as t } from 'react';
const e = t((t, e) => {
  const { children: i, size: h, ...x } = t,
    o = h || '24px',
    a = {
    ...
    c = h && Object.prototype.hasOwnProperty.call(a, o) ? a[o] : a?.['24px'];
  return p(r, {
    ref: e,
...
e.displayName = 'IconWrapper';
export { e as IconWrapper };
