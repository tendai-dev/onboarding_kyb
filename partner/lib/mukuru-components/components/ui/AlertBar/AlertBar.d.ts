import type { AlertBarProps } from './AlertBar.types';
/**
 ...
 *
 */
export declare const AlertBar: import('react').ForwardRefExoticComponent<
  AlertBarProps & import('react').RefAttributes<HTMLDivElement>
>;
//# sourceMappingURL=AlertBar.d.ts.map
