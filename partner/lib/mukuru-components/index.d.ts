...
export type switchSlotRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'root' | 'indicator' | 'control' | 'label' | 'thumb',
  {
    variant: {
      solid: {
        control: {
...
interface SwitchProps
  extends PropsWithChildren<Omit<Switch$1.RootProps, 'size'>>,
    CheckboxVariantProps$1 {
...
export type menuRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'indicator'
  | 'content'
  | 'separator'
  | 'item'
  ...
  | 'itemCommand'
  | 'activeItem',
  _chakra_ui_react.SlotRecipeVariantRecord<
    | 'indicator'
    | 'content'
    | 'separator'
    | 'item'
...
interface SelectionMenuProps
  extends Omit<MenuRootProviderProps, 'variant' | 'children' | 'value'>,
    SelectionMenuVariantProps {
 ...
 */
declare const SelectionMenu: react.ForwardRefExoticComponent<
  SelectionMenuProps & react.RefAttributes<HTMLButtonElement>
>;

export type servicesMenuRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'content'
  | 'grid'
  | 'icon'
  | 'item'
 ...
 */
declare const ServicesMenu: react.ForwardRefExoticComponent<
  ServicesMenuProps & react.RefAttributes<HTMLButtonElement>
>;

export type profileMenuRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'content' | 'avatar' | 'item' | 'fullName' | 'avatarFallback',
  _chakra_ui_react.SlotRecipeVariantRecord<
    'content' | 'avatar' | 'item' | 'fullName' | 'avatarFallback'
  >
>;
 ...
 */
declare const ProfileMenu: react.ForwardRefExoticComponent<
  ProfileMenuProps & react.RefAttributes<HTMLButtonElement>
>;
 ...
 */
declare const MukuruLogo: ({
  inverse,
  ...props
}: MukuruLogoProps) => react_jsx_runtime.JSX.Element;

export type buttonRecipe = _chakra_ui_react.RecipeDefinition<{
  size: {
    sm: {
      borderRadius: '36px';
      height: '32px';
...
interface ButtonProps
  extends Omit<ButtonProps$1, 'color' | 'size' | 'variant'>,
    ButtonVariantProps {
  children?: ReactNode;
  disabled?: boolean;
  loading?: boolean;
...
export type typographyRecipe = _chakra_ui_react.RecipeDefinition<{
  levels: {
    h1: {
      textStyle: 'headline1';
    };
...
export type radioRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'root' | 'label' | 'item' | 'itemIndicator' | 'itemText' | 'itemControl',
  {
    size: {
      sm: {
        itemControl: {
...
interface RadioProps
  extends PropsWithChildren<RadioGroup$1.ItemProps>,
    RadioVariantProps {}
...
export type checkboxRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'root' | 'indicator' | 'control' | 'label' | 'group',
  {
    size: {
      sm: {
        root: {
...
interface CheckboxProps
  extends PropsWithChildren<Omit<Checkbox$1.RootProps, 'size'>>,
...
export type tagRecipe = _chakra_ui_react.RecipeDefinition<{
  variant: {
    success: {
      bg: 'mukuru.teal.400';
 ...
 *
 */
declare const IconWrapper: react.ForwardRefExoticComponent<
  Omit<IconProps$1, 'size'> & {
 ...
 */
declare const MobileSidebar: react__default.ForwardRefExoticComponent<
  MobileSidebarProps & react__default.RefAttributes<HTMLDivElement>
>;

export type alertBarRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'root'
  | 'indicator'
  | 'content'
  | 'title'
 ...
 *
 */
declare const AlertBar: react.ForwardRefExoticComponent<
  AlertBarProps & react.RefAttributes<HTMLDivElement>
>;

export type portalNavigationSidebarRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'root'
  | 'tooltip'
  | 'navigation'
  | 'navigationList'
...
type PortalNavigationSidebarVariantProps = RecipeVariantProps<
  typeof portalNavigationSidebarRecipe
>;
...
interface PortalNavigationSidebarProps
  extends Omit<HTMLAttributes<HTMLElement>, 'color'>,
    PortalNavigationSidebarVariantProps {
 ...
 */
declare const PortalNavigationSidebar: react.ForwardRefExoticComponent<
  PortalNavigationSidebarProps & react.RefAttributes<HTMLElement>
>;
...
export type typeAheadRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'root'
  | 'label'
  | 'content'
  | 'item'
...
interface TypeAheadProps
  extends TypeAheadVariantProps,
    Omit<MenuRootProviderProps, 'value' | 'children' | 'variant'> {
  value?: string;
...
export type radioDropdownRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'root'
  | 'indicator'
  | 'content'
  | 'radioGroup'
...
declare const RadioDropdown: {
  ({
    ...
    showClear,
    clearLabel,
  }: RadioDropdownProps): react_jsx_runtime.JSX.Element;
  displayName: string;
};

export type dropdownRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'root'
  | 'label'
  | 'content'
  | 'item'
...
export type tooltipRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'content' | 'positioner' | 'trigger' | 'arrow' | 'arrowTip',
  _chakra_ui_react.SlotRecipeVariantRecord<
    'content' | 'positioner' | 'trigger' | 'arrow' | 'arrowTip'
  >
>;
...
export type modalRecipe = _chakra_ui_react.SlotRecipeDefinition<
  | 'content'
  | 'body'
  | 'footer'
  | 'header'
...
export type cardRecipe = _chakra_ui_react.SlotRecipeDefinition<
  'root' | 'body' | 'footer' | 'header' | 'title' | 'description',
  _chakra_ui_react.SlotRecipeVariantRecord<
    'root' | 'body' | 'footer' | 'header' | 'title' | 'description'
  >
>;
...
declare function MukuruComponentProvider(
  props: ColorModeProviderProps
): react_jsx_runtime.JSX.Element;
...
type IconType = (
  props: react__default.SVGProps<SVGSVGElement>
