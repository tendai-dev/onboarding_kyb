...
if (typeof global.URLSearchParams === 'undefined') {
  global.URLSearchParams = NodeURLSearchParams as typeof URLSearchParams;
}
...
if (typeof global.DataTransfer === 'undefined') {
  (global as { DataTransfer?: typeof DataTransfer }).DataTransfer =
...
if (typeof global.ResizeObserver === 'undefined') {
  (global as { ResizeObserver?: typeof ResizeObserver }).ResizeObserver = vi
    .fn()
    .mockImplementation(() => ({
      observe: vi.fn(),
      unobserve: vi.fn(),
...
vi.mock('framer-motion', () => ({
  motion: {
    create: (Component: Record<string, unknown>) => Component,
    div: 'div',
    span: 'span',
    button: 'button',
  },
