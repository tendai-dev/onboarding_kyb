...
const conversations = [
  {
    ...
    lastMessage:
      'We need additional information regarding your expected transaction volumes.',
...
const messages = [
  {
    ...
    senderType: 'admin',
    message:
      "Hello! I'm reviewing your application and need some additional information about your expected transaction volumes. Could you provide more details about your business model?",
  ...
  },
  {
    ...
    senderType: 'partner',
    message:
      'Hi John, thank you for reaching out. Our business primarily handles B2B payments for small to medium enterprises. We expect to process approximately $75,000 monthly in the first year.',
  ...
  },
  {
    ...
    senderType: 'partner',
    message:
      "I've also attached our business plan which includes detailed financial projections for the next 3 years.",
    timestamp: '2024-10-24 15:47',
    attachments: [{ name: 'Business_Plan_2024.pdf', size: '2.3 MB' }],
  },
  {
    id: 4,
    sender: 'John Smith',
    senderType: 'admin',
    message:
      "Perfect! Thank you for the detailed information and the business plan. I'll review these documents and get back to you within 24 hours with next steps.",
...
export default function MessagesPage() {
  ...
  const handleSendMessage = () => {
    if (newMessage.trim()) {
      ...
      console.info('Sending message:', newMessage);
      setNewMessage('');
    }
  };
                      ...
                      >
                        <HStack gap="3" align="start">
                          ...
                          <VStack align="start" gap="1" flex="1" minW="0">
                            ...
                            <Typography fontSize="xs" color="gray.600" mb="1">
                              {conversation.applicationId}
                            </Typography>
                            <Typography fontSize="sm" color="gray.700" lineClamp={2}>
                  ...
                  <HStack justify="space-between">
                    <HStack gap="3">
                      ...
                      <VStack align="start" gap="0">
                        <Typography fontWeight="semibold">TechCorp Solutions</Typography>
                  ...
                  <VStack gap="4" align="stretch">
                    {messages.map((message) => (
                      ...
                      >
                        <Flex
                          justify={
                            message.senderType === 'partner' ? 'flex-end' : 'flex-start'
                          }
                        >
                          <Box maxW="70%">
                            <HStack
                            ...
                            >
                              ...
                              <VStack
                                align={message.senderType === 'partner' ? 'end' : 'start'}
                                gap="0"
                              >
                            ...
                            <Box
                              bg={
                                message.senderType === 'partner' ? 'blue.500' : 'gray.100'
                              }
                              color={
                                message.senderType === 'partner' ? 'white' : 'gray.800'
                              }
                              p="3"
                              borderRadius="lg"
                              borderTopLeftRadius={
                                message.senderType === 'admin' ? '4px' : 'lg'
                              }
                              borderTopRightRadius={
                                message.senderType === 'partner' ? '4px' : 'lg'
                              }
                            >
                              <Typography fontSize="sm" lineHeight="1.5">
                                {message.message}
                              </Typography>
                                  ...
                                  {message.attachments.map((attachment, index) => (
                                    ...
                                    >
                                      ...
                                      <VStack align="start" gap="0">
                                        ...
                                        <Typography fontSize="xs" opacity="0.8">
                                          {attachment.size}
                                        </Typography>
                                      </VStack>
                                    </HStack>
