...
describe('PartnerProfilePage', () => {
  beforeEach(() => {
    ...
    (api.getUserProfile as unknown).mockResolvedValue({
      firstName: 'Test',
      lastName: 'User',
      email: 'test@example.com',
    });
    (api.getNotificationPreferences as unknown).mockResolvedValue({});
    (api.getUserCaseSummary as unknown).mockResolvedValue({});
  });
