...
vi.mock('@/components/EnhancedDynamicForm', () => ({
  EnhancedDynamicForm: ({ formData, onFieldChange, currentStep, isEditing }: unknown) => (
...
describe('ApplicationDetailsPage', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    (useParams as unknown).mockReturnValue({ id: 'test-case-id' });
    (useRouter as ReturnType<typeof vi.fn>).mockReturnValue(mockRouter);
    (getAuthUser as unknown).mockReturnValue({
      name: 'Test User',
      email: 'test@example.com',
    });
    (generateUserIdFromEmail as unknown).mockReturnValue('test-partner-id');
    (findUserCaseByEmail as unknown).mockResolvedValue({
      caseId: 'test-case-id',
      partnerId: 'test-partner-id',
    });
  ...
  describe('Save Functionality', () => {
    ...
    it('should handle save errors', async () => {
      ...
      (SweetAlert.error as unknown) = vi.fn().mockResolvedValue({});
