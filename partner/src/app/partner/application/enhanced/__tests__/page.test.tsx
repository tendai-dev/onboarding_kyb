...
describe('EnhancedNewPartnerApplicationPage', () => {
  ...
  beforeEach(() => {
    ...
    (useFormPersistence as unknown).mockReturnValue({
  ...
  describe('User Authentication', () => {
    ...
    it('should handle missing user', () => {
      (getAuthUser as unknown).mockReturnValue(null);
  ...
  describe('Step Completion', () => {
    it('should sync step completion with backend services', async () => {
      (integrationService.integrationService.getChecklistByCase as unknown) = vi
        .fn()
        .mockResolvedValue({
          items: [{ id: 'item-1', category: 'Compliance' }],
        });
      (integrationService.integrationService.completeChecklistItem as unknown) = vi
        .fn()
        .mockResolvedValue({});
      (integrationService.integrationService.updateWorkQueueItem as unknown) = vi
        .fn()
        .mockResolvedValue({});
  ...
  describe('Error Handling', () => {
    it('should handle entity types fetch error', async () => {
      (mockEntityConfigApiService.getEntityTypes as unknown).mockRejectedValue(
