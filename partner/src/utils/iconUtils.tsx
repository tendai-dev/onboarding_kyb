...
export function getEntityTypeIcon(
  ...
  if (code) {
    ...
    if (
      ...
      code.includes('state_owned') ||
      code.includes('state-owned') ||
      code.includes('parastatal') ||
      code.includes('organ_of_state')
    ) {
      return 'FiShield';
    }
    ...
    if (
      ...
      code.includes('ngo') ||
      code.includes('pvo') ||
      code.includes('charity') ||
      code.includes('non_profit') ||
      code.includes('nonprofit')
    ) {
      return 'FiHeart';
    }
    ...
    if (
      code.includes('private_company') ||
      code.includes('private-company') ||
      code.includes('llc') ||
      code.includes('limited_liability')
    ) {
      return 'FiBriefcase';
    }
    ...
    if (
      code.includes('public_company') ||
      code.includes('public-company') ||
      code.includes('publicly_listed') ||
      code.includes('publicly-listed')
    ) {
      return 'FiTrendingUp';
    }
    ...
    // Sole Proprietor
    if (
      code.includes('sole_proprietor') ||
      code.includes('sole-proprietor') ||
      code.includes('sole_trader') ||
      code.includes('sole-trader')
    ) {
      return 'FiUser';
    }
    ...
    if (
      code.includes('supranational') ||
      code.includes('inter_governmental') ||
  ...
  if (label) {
    ...
    if (
      ...
      label.includes('state owned') ||
      label.includes('state-owned') ||
      label.includes('organ of state') ||
      label.includes('parastatal')
    ) {
      return 'FiShield';
    }
    ...
    if (
      ...
      label.includes('society') ||
      label.includes('foundation') ||
      label.includes('non-registered') ||
      label.includes('non registered')
    ) {
      return 'FiUsers';
    }
    ...
    // Private Company / Limited Liability Company
    if (
      label.includes('private company') ||
      label.includes('limited liability') ||
      label.includes('llc') ||
      (label.includes('private') && label.includes('company'))
    ) {
      return 'FiBriefcase';
    }
    ...
    // Publicly Listed Entity
    if (
      label.includes('publicly listed') ||
      label.includes('public company') ||
    ...
    // Sole Proprietor
    if (
      label.includes('sole proprietor') ||
      label.includes('sole trader') ||
      label.includes('sole-proprietor') ||
      label.includes('sole-trader')
    ) {
      return 'FiUser';
    ...
    // Supranational / Inter-Governmental
    if (
      label.includes('supranational') ||
      label.includes('inter-governmental') ||
      label.includes('intergovernmental') ||
      label.includes('inter governmental')
    ) {
      return 'FiGlobe';
    }
