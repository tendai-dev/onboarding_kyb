...
describe('a11yUtils', () => {
  ...
  describe('createSkipLink', () => {
    it('should create skip link', () => {
      const skipLink = a11yUtils.createSkipLink('main-content', 'Skip to main content');
  ...
  describe('useScreenReader', () => {
    ...
    it('should detect screen reader from user agent', () => {
      Object.defineProperty(navigator, 'userAgent', {
        writable: true,
        value:
          'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36 NVDA',
      });
  ...
  describe('useA11yFocusTrap', () => {
    ...
    it('should trap focus when active', () => {
      ...
      (result.current as unknown).current = container;
