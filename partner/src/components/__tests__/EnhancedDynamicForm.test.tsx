...
// Mock dependencies
vi.mock('../FileUpload', () => ({
  FileUpload: ({ onFileUpload, label, description }: unknown) => (
...
describe('EnhancedDynamicForm', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should not render if current step is invalid', () => {
      // eslint-disable-next-line react/jsx-props-no-spreading
      renderWithProviders(<EnhancedDynamicForm {...defaultProps} currentStep={999} />);
    ...
    it('should render step 2 when currentStep is 2', () => {
      // eslint-disable-next-line react/jsx-props-no-spreading
      renderWithProviders(<EnhancedDynamicForm {...defaultProps} currentStep={2} />);
  ...
  describe('Field Interactions', () => {
    ...
    it('should call onFieldChange when radio changes', () => {
      ...
      const radio1 = screen
        .getByText('Type 1')
        .previousElementSibling?.querySelector('input[type="radio"]');
      if (radio1) {
  ...
  describe('Loading State', () => {
    it('should disable fields when isLoading is true', () => {
      // eslint-disable-next-line react/jsx-props-no-spreading
      renderWithProviders(<EnhancedDynamicForm {...defaultProps} isLoading={true} />);
