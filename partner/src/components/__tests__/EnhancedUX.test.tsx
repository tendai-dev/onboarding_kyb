...
let KeyboardShortcutsHelp: React.ComponentType | undefined;
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const mod = require('../EnhancedUX');
  KeyboardShortcutsHelp = mod.KeyboardShortcutsHelp;
} catch {
...
vi.mock('@chakra-ui/react', async (importOriginal) => {
  ...
  return {
    ...
    ModalCloseButton: ({ onClick }: { onClick?: () => void }) => (
      <button data-testid="modal-close" onClick={onClick} />
    ),
